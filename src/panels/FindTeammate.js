					...
					wall.push(
						...
						>
							...
							{el.verified == 1 && (
								<MiniInfoCell
									before={
										<Icon20CheckCircleOutline fill="#4cad64" />
									}
									textWrap="full"
									textLevel="primary"
								>
						...
						<Tabbar>
							...
							{this.state.spinner === false && (
								<>
									...
									<TabbarItem
										selected={
											this.state.activeStory === "profile"
										}
										data-story="profile"
										onClick={this.openPage}
										text="Профиль"
								...
								<Group mode="plain">
									...
									{this.state.battleTag !== null && (
										<SimpleCell
											...
											after={
												this.state.switches.profileTag
											}
										>
											{this.state.profile[0].battletag
												? this.state.profile[0]
