      ...
      <Panel id={id} className="homePage">
        ...
        >
          <Panel id="feed" activeStory="feed">
            ...
            <Group>
              <CardGrid size="l">{this.state.groups[0].rows}</CardGrid>
            </Group>
          </Panel>
          ...
          <Panel id="arcades" activeStory="arcades">
            ...
            <Group
              header={<Header mode="secondary">СПИСОК АРКАД НА СЕГОДНЯ</Header>}
            >
            ...
            <Div>
              <Card>
                <Div>
                  <Text weight="regular">
                    История аркад обновляется ежедневно в 07:00 по МСК.
                  </Text>
                </Div>
              </Card>
            </Div>
            ...
            <Div>
              <Card>
                <Div>
                  ...
                  <Text weight="regular">
                    Здесь отображены аркады за последние 3 дня, включая
                    сегодняший. Чтобы посмотреть аркады за всё время работы
                    Overwatch Daily Arcade, нажмите на соответствующую кнопку
                    ниже. Кнопка перенаправит Вас на наше официальное
                    сообщество.
                  </Text>
                </Div>
              </Card>
