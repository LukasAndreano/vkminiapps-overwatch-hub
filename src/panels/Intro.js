          ...
          <Group>
            ...
            <Div className="WelcomeBlock">
              ...
              <Title level="1" weight="bold" style={{ marginBottom: 16 }}>
                Добро пожаловать в Overwatch Hub, {user.first_name}!
              </Title>
              <Text weight="regular">
                Благодаря этому приложению ты в любой момент времени можешь
                узнать актуальный список аркад, посмотреть мемчики, арты,
                скриншотики со своим любимым персонажем, а также узнать новости
                из вселенной Overwatch.
              </Text>
