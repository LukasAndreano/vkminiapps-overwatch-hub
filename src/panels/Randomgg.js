        ...
        {this.state.name == null && (
          <Group>
            <Div className="WelcomeBlock">
              ...
              <Text weight="regular">
                Не знаешь на какого персонажа купить золотое оружие? Этот раздел
        ...
        {this.state.name !== null && (
          <Group>
            ...
            <Div className="WelcomeBlock">
              ...
              <Text weight="regular">
                Рандомайзер принял своё решение. Однозначно нужно покупать
                золотое оружие на {this.state.name}!
              </Text>
              <Button size="l" stretched mode="secondary" onClick={this.random}>
                Попробовать еще раз!
              </Button>
