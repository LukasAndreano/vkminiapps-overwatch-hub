				...
				<Div>
					<Card>
						<Div>
							...
							<Text weight="regular">
								Ивент «Архивы» уже завёршен. Однако мы, как
								всегда, оставили эту страницу до следующего
								обновления игры.
							</Text>
						</Div>
					</Card>
