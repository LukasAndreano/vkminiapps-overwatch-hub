		...
		<Panel id={id}>
			...
			<CardGrid size="l" style={{paddingTop: 15}}>
			    <ContentCard
			        ...
			        maxHeight={200}
					onClick={() => {this.openImage("https://sun9-47.userapi.com/impg/LPQJwuF3nLPsuuh6uphZenRfzDFgvSoi_oN3tg/lN0eKPDavS0.jpg?size=1280x719&quality=96&sign=a19c502076b0cb982eed0f4bd57a1122&type=album")}}
					disabled
			    />
			</CardGrid>
		    <Div>
		      <Button size="l" stretched mode="secondary" onClick={() => go('home')}>Назад в меню</Button>
		    </Div>
		</Panel>
		)
	}
